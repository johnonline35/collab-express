...
export type BaseContext<TOpts extends ClientOptions, TTrigger extends keyof EventsFromOpts<TOpts> & string, TShimmedFns extends Record<string, (...args: unknown[]) => unknown>> = {
    /**
     * The event data present in the payload.
     */
 ...
 * keys.
 */
export type Context<TOpts extends ClientOptions, TEvents extends Record<string, EventPayload>, TTrigger extends keyof TEvents & string, TShimmedFns extends Record<string, (...args: unknown[]) => unknown>, TOverrides extends Record<string, unknown> = Record<never, never>> = Omit<BaseContext<TOpts, TTrigger, TShimmedFns>, keyof TOverrides> & TOverrides;
/**
 ...
 * @public
 */
export type Handler<TOpts extends ClientOptions, TEvents extends EventsFromOpts<TOpts>, TTrigger extends keyof TEvents & string, TShimmedFns extends Record<string, (...args: unknown[]) => unknown> = Record<never, never>, TOverrides extends Record<string, unknown> = Record<never, never>> = (
/**
 * The context argument provides access to all data and tooling available to
 * the function.
 */
ctx: Context<TOpts, TEvents, TTrigger, TShimmedFns, TOverrides>) => unknown;
/**
...
export type Cancellation<Events extends Record<string, EventPayload>, TriggeringEvent extends keyof Events & string> = {
    [K in keyof Events & string]: {
         ...
         */
        match?: IsStringLiteral<keyof Events & string> extends true ? ObjectPaths<Events[TriggeringEvent]> & ObjectPaths<Events[K]> : string;
        /**
